...
export class InstancedPresenter {
  player: Player;
  instanceCallback: (player: Player) => IEntity[];
  scene: THREE.Group;
  material?: THREE.Material;
  geometry?: THREE.BufferGeometry;
  instancedMesh?: THREE.InstancedMesh;

  constructor(player: Player, instanceCallback: (player: Player) => IEntity[], geometry: THREE.BufferGeometry, scene: THREE.Group) {
    this.player = player;
