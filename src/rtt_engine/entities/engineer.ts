...
export interface IEngineer extends abilities.IConstructableEntity, abilities.IOwnableEntity, abilities.ICollidableEntity, abilities.IEngineerEntity, abilities.IPathableEntity {
  kind: "engineer";
}
